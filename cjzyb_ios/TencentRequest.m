...
static NSString* kStringBoundary = @"od2ER5ioefd682HE14eh2n82n9M7rEu2nH85XQY1";
static const int kGeneralErrorCode = 10000;
static const NSTimeInterval kTimeoutInterval = 180.0;

@implementation TencentRequest

@synthesize delegate = _delegate,url = _url,httpMethod = _httpMethod,params = _params,connection = _connection,responseText = _responseText;
...
//            UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil message:@"QQ空间分享成功！" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil];
//            [alert show];
//            [alert release];
//            [SVProgressHUD showSuccessWithStatus:@"QQ空间分享成功！"];
        }else{
//            UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil message:@"QQ空间分享失败！" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil];
//            [alert show];
//            [alert release];
        }
    }
...
- (void)handleResponseData:(NSData *)data {
	...
	if ([_delegate respondsToSelector:@selector(request:didLoad:dat:)] ||
